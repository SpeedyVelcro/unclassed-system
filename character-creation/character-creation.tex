...
\begin{multicols}{2}
    ...
    \subsection{Advancement}\label{levels}\index{levels}\label{experience points}\index{experience points}\label{experience threshold}\index{experience threshold}\label{advancement}\index{advancement}
    ...
    experience points (XP) to meet their experience threshold\index{experience threshold}. XP is awarded
    by the GM for overcoming challenges.
    \begin{table*}[ht]
        \unclassedrowcolors
    ...
    \begin{itemize}
        \item The character rolls its health die, and then adds the result +
            ...
            amount).\index{health die}\index{health points}\index{maximum health points}
        \item The character rolls its mana die, and then adds the result + SOR
            ...
            this amount).\index{mana die}\index{mana points}\index{maximum mana points}
        \item The character increases any attribute by 1.\index{attributes}
        \item The character increases the potential of X different skills by 1,
            where X is their INT (at least 1).\index{potential}
        \item The character gains 1 feat point.\index{feats}\index{feat points}
        \item XP is reduced by the threshold of their current level (see table
            \ref{tab:levels}), and their level is increase by 1.\index{experience points}\index{level}\index{experience threshold}
    \end{itemize}
\end{multicols}
