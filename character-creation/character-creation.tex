...
\begin{multicols}{2}
    ...
    \subsection{Advancement}\label{levels}\index{levels}\label{experience points}\index{experience points}\label{experience threshold}\index{experience threshold}
