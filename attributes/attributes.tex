...
\begin{multicols*}{2}
    \begin{table*}[ht!]
        ...
        \begin{tabularx}{\textwidth}{l l X}
            ...
            % FAV & Favor & Connection to one's deity \\
        \end{tabularx}
        \caption{Attributes}
        \label{tab:attributes}

        % TODO: move labels to their individual attribute subsections once those are added.
        \label{strength}\index{strength}
        \label{dexterity}\index{dexterity}
        \label{endurance}\index{endurance}
        \label{senses}\index{senses}
        \label{intelligence}\index{intelligence}
        \label{willpower}\index{willpower}
        \label{acumen}\index{acumen}
        \label{charisma}\index{charisma}
        \label{sorcery}\index{sorcery}
        % \index{psyche}
        % \index{favor}
    \end{table*}
