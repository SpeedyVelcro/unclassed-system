...
\begin{multicols}{2}
    ...
    \section{Weapons}
    % Weapons should be given in a mixed intuitive/alphabetical order
    % i.e. alphabetical, until it makes more sense to group weapons together
    % or a certain weapon should be first.
    % Some examples of the exceptions to alphabetical order:
    % Swords are grouped together under S.
    % Hands are grouped together at the beginning of natural weapons.
    % Bows are grouped together, under which crossbows are also grouped together.
    % Grouped weapons may be ordered by size rather than alphabetically
    % TODO: replace all these maths environment times with texttimes
    % TODO: Now that there are strength minimums, STR can be removed from range formulae
    % TODO: explain min STR (you can have less STR, but get penalty equal to difference)
    \begin{table*}[ht!]
        \unclassedrowcolors
        \begin{tabularx}{\textwidth}{X l l l l l l l}
            ...
            Foot* & - & - & 1d4 + STR {\texttimes} 2 b & 20, {\texttimes}2 & - & - & \pageref{weapon:foot} \\ % Penalty when attacking anything at torso height, even bigger penalty at head height
            Head* & - & - & 1d6 + STR {\texttimes} 2 b & 20, {\texttimes}2 & - & - & \pageref{weapon:head} \\ % Headbutting should come with serious risk of concussion, or opportunity attacks or something
            Teeth & - & - & 1d3 p & 20, {\texttimes}2 & - & - & \pageref{weapon:teeth} \\ % Human teeth are not suited to biting live prey
            ...
            Bastard Sword* & ? & 1 & 1d6 + STR s & 19-20, {\texttimes}2 & - & 4 lb. \pageref{weapon:bastard-sword} \\ % Switching from 1 to 2 handed is free
            ...
            Hand Crossbow* & ? & - & 1d6 p & 18-20, {\texttimes}2 & 30 ft. & 3 lb. & \pageref{weapon:hand-crossbow} \\ % 1-action reload
            \unclassedsubtabletitle{7}{Two-Handed Ranged Weapons} \\
            \textbf{Weapon} & \textbf{Cost} & \textbf{Min. STR} & \textbf{Damage} & \textbf{Critical} & \textbf{Range} & \textbf{Weight} & \textbf{Page} \\
            Shortbow & ? & 2 & 1d6 + 1 p & 19-20, {\texttimes}2 & 30 ft. & ? & \pageref{weapon:shortbow} \\ % Default reaload of 1/2 action
            Longbow & ? & 4 & 1d6 + 3 p & 19-20, {\texttimes}2 & 40 ft. & ? & \pageref{weapon:longbow} \\
            Light Crossbow* & ? & - & 1d6 + 2 p & 18-20, {\texttimes}2 & 30 ft. & 4 lb. & \pageref{weapon:light-crossbow} \\ % 1-action reload
            Heavy Crossbow* & ? & 0 & 1d6 + 4 p & 18-20, {\texttimes}2 & 30 ft. & 6 lb. & \pageref{weapon:heavy-crossbow} \\ % 1-action reload
            Siege Crossbow* & ? & 1 & 1d6 + 8 p & 18-20, {\texttimes}2 & 40 ft. & 10 lb. & \pageref{weapon:siege-crossbow} \\ % Full turn/round (?) reload? Arguably this should be even longer for realism. Come back to this.
            Repeating Crossbow* & ? & - & 1d6 p & 18-20, {\texttimes}2 & 30 ft. & 6 lb. & \pageref{weapon:repeating-crossbow} \\ % a.k.a. Chu Ko Nu. No reload because reload is part of the same motion as firing.
    ...
    \subsection{Critical}
    Weapons have a critical threat range\index{critical threat range} and a
    critical damage multiplier\index{critical damage multiplier}, listed
