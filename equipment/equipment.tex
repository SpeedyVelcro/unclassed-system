...
\begin{multicols}{2}
    ...
    \begin{table*}[ht!]
        ...
        \begin{tabularx}{\textwidth}{X l l l l l l l}
            ...
            Foot* & - & - & 1d4 + STR {\texttimes} 2 b & 20, $\times$2 & - & - & \pageref{weapon:foot} \\ % Penalty when attacking anything at torso height, even bigger penalty at head height
            Head* & - & - & 1d6 + STR {\texttimes} 2 b & 20, $\times$2 & - & - & \pageref{weapon:head} \\ % Headbutting should come with serious risk of concussion, or opportunity attacks or something
            ...
            Bastard Sword* & ? & 1 & 1d6 + STR s & 20, $\times$2 & - & 4 lb. \pageref{weapon:bastard-sword} \\ % Switching from 1 to 2 handed is free
            ...
            \textbf{Weapon} & \textbf{Cost} & \textbf{Min. STR} & \textbf{Damage} & \textbf{Critical} & \textbf{Range} & \textbf{Weight} & \textbf{Page} \\
            Shortbow & ? & 1 & 1d6 + 1 p & 20, $\times$2 & 30 + STR $\times$ 10 ft. & ? & \pageref{weapon:shortbow} \\ % If the range is 0 or less, you are simply not strong enough to draw the string
            ...
            Siege Crossbow* & ? & 1 & 1d6 + 8 p & 20, $\times$2 & 60 ft. & 10 lb. & \pageref{weapon:siege-crossbow} \\ % More complex and time-consuming reloading
